...
.showMsg{border: 1px solid #999; background:#f7f7f7; zoom:1; width:450px; height:172px;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px}
...
.showMsg .bottom{ background:#dddddd; line-height:26px; *line-height:30px; height:26px; text-align:center}
