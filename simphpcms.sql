...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-01-10 06:32:54
-- 服务器版本： 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `sim_admin` (
...
INSERT INTO `sim_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`, `card`, `lang`) VALUES
(1, 'admin', '680b57331edb63f01b3e0c2e680a097d', 1, 'yeNZcH', '', 0, 'simleaf999@gmail.com', '', '', '');

-- --------------------------------------------------------

--
-- 表的结构 `sim_admin_panel`
--

CREATE TABLE IF NOT EXISTS `sim_admin_panel` (
...
CREATE TABLE IF NOT EXISTS `sim_admin_role` (
...
--
-- 转存表中的数据 `sim_admin_role`
--

INSERT INTO `sim_admin_role` (`roleid`, `rolename`, `description`, `listorder`, `disabled`) VALUES
(1, '超级管理员', '超级管理员', 0, 0),
(2, '站点管理员', '站点管理员', 0, 0),
(3, '运营总监', '运营总监', 1, 0),
(4, '总编', '总编', 5, 0),
...
--
-- 表的结构 `sim_admin_role_priv`
--

CREATE TABLE IF NOT EXISTS `sim_admin_role_priv` (
...
CREATE TABLE IF NOT EXISTS `sim_announce` (
...
CREATE TABLE IF NOT EXISTS `sim_attachment` (
...
--
-- 表的结构 `sim_attachment_index`
--

CREATE TABLE IF NOT EXISTS `sim_attachment_index` (
...
CREATE TABLE IF NOT EXISTS `sim_badword` (
...
CREATE TABLE IF NOT EXISTS `sim_block` (
`id` int(10) NOT NULL,
...
--
-- 表的结构 `sim_block_history`
--

CREATE TABLE IF NOT EXISTS `sim_block_history` (
`id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_block_priv` (
...
INSERT INTO `sim_cache` (`filename`, `path`, `data`) VALUES
...
CREATE TABLE IF NOT EXISTS `sim_category` (
...
--
-- 转存表中的数据 `sim_category`
--

INSERT INTO `sim_category` (`catid`, `siteid`, `module`, `type`, `modelid`, `parentid`, `arrparentid`, `child`, `arrchildid`, `catname`, `style`, `image`, `description`, `parentdir`, `catdir`, `url`, `items`, `hits`, `setting`, `listorder`, `ismenu`, `sethtml`, `letter`, `usable_type`) VALUES
...
--
-- 表的结构 `sim_category_priv`
--

CREATE TABLE IF NOT EXISTS `sim_category_priv` (
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_collection_content`
--

CREATE TABLE IF NOT EXISTS `sim_collection_content` (
`id` int(10) unsigned NOT NULL,
...
--
-- 表的结构 `sim_collection_history`
--

CREATE TABLE IF NOT EXISTS `sim_collection_history` (
...
--
-- 表的结构 `sim_collection_node`
--

CREATE TABLE IF NOT EXISTS `sim_collection_node` (
...
--
-- 表的结构 `sim_collection_program`
--

CREATE TABLE IF NOT EXISTS `sim_collection_program` (
`id` int(10) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `nodeid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_comment_check`
--

CREATE TABLE IF NOT EXISTS `sim_comment_check` (
`id` int(10) NOT NULL,
...
--
-- 表的结构 `sim_comment_data_1`
--

CREATE TABLE IF NOT EXISTS `sim_comment_data_1` (
...
--
-- 表的结构 `sim_comment_setting`
--

CREATE TABLE IF NOT EXISTS `sim_comment_setting` (
  `siteid` smallint(5) NOT NULL DEFAULT '0' COMMENT '站点ID',
...
--
-- 转存表中的数据 `sim_comment_setting`
--

INSERT INTO `sim_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES
(1, 0, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `sim_comment_table`
--

CREATE TABLE IF NOT EXISTS `sim_comment_table` (
...
--
-- 转存表中的数据 `sim_comment_table`
--

INSERT INTO `sim_comment_table` (`tableid`, `total`, `creat_at`) VALUES
(1, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `sim_content_check`
--

CREATE TABLE IF NOT EXISTS `sim_content_check` (
...
CREATE TABLE IF NOT EXISTS `sim_copyfrom` (
...
CREATE TABLE IF NOT EXISTS `sim_datacall` (
`id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_dbsource` (
`id` int(10) NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `sim_download` (
...
--
-- 表的结构 `sim_download_data`
--

CREATE TABLE IF NOT EXISTS `sim_download_data` (
...
--
-- 表的结构 `sim_downservers`
--

CREATE TABLE IF NOT EXISTS `sim_downservers` (
...
--
-- 表的结构 `sim_extend_setting`
--

CREATE TABLE IF NOT EXISTS `sim_extend_setting` (
`id` smallint(5) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_favorite` (
`id` int(10) unsigned NOT NULL,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `title` char(100) NOT NULL,
  `url` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_hits` (
...
CREATE TABLE IF NOT EXISTS `sim_ipbanned` (
...
CREATE TABLE IF NOT EXISTS `sim_keylink` (
...
CREATE TABLE IF NOT EXISTS `sim_keyword` (
`id` int(10) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_keyword_data`
--

CREATE TABLE IF NOT EXISTS `sim_keyword_data` (
`id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_link` (
...
INSERT INTO `sim_link` (`linkid`, `siteid`, `typeid`, `linktype`, `name`, `url`, `logo`, `introduce`, `username`, `listorder`, `elite`, `passed`, `addtime`) VALUES
(1, 1, 0, 1, 'PHPCMS', 'http://www.phpcms.cn', 'http://www.phpcms.cn/images/logo_88_31.gif', '', '', 0, 0, 1, 1420866583),
(2, 1, 0, 1, '盛大在线', 'http://www.sdo.com', 'http://www.snda.com/cn/logo/comp_logo_sdo.gif', '', '', 0, 0, 1, 1420866583);
...
CREATE TABLE IF NOT EXISTS `sim_linkage` (
...
INSERT INTO `sim_linkage` (`linkageid`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`) VALUES
...
INSERT INTO `sim_log` (`logid`, `field`, `value`, `module`, `file`, `action`, `querystring`, `data`, `userid`, `username`, `ip`, `time`) VALUES
(1, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '127.0.0.1', '2015-01-10 13:09:51');
...
--
-- 表的结构 `sim_member_detail`
--

CREATE TABLE IF NOT EXISTS `sim_member_detail` (
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_member_group`
--

CREATE TABLE IF NOT EXISTS `sim_member_group` (
...
--
-- 转存表中的数据 `sim_member_group`
--

INSERT INTO `sim_member_group` (`groupid`, `name`, `issystem`, `starnum`, `point`, `allowmessage`, `allowvisit`, `allowpost`, `allowpostverify`, `allowsearch`, `allowupgrade`, `allowsendmessage`, `allowpostnum`, `allowattachment`, `price_y`, `price_m`, `price_d`, `icon`, `usernamecolor`, `description`, `sort`, `disabled`) VALUES
...
--
-- 表的结构 `sim_member_menu`
--

CREATE TABLE IF NOT EXISTS `sim_member_menu` (
...
--
-- 转存表中的数据 `sim_member_menu`
--

INSERT INTO `sim_member_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `isurl`, `url`) VALUES
...
--
-- 表的结构 `sim_member_verify`
--

CREATE TABLE IF NOT EXISTS `sim_member_verify` (
`userid` mediumint(8) unsigned NOT NULL,
  `username` char(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_member_vip` (
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `sim_menu` (
`id` smallint(6) unsigned NOT NULL,
  `name` char(40) NOT NULL DEFAULT '',
  `parentid` smallint(6) NOT NULL DEFAULT '0',
  `m` char(20) NOT NULL DEFAULT '',
...
INSERT INTO `sim_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES
...
--
-- 表的结构 `sim_message_data`
--

CREATE TABLE IF NOT EXISTS `sim_message_data` (
`id` int(4) NOT NULL,
...
--
-- 表的结构 `sim_message_group`
--

CREATE TABLE IF NOT EXISTS `sim_message_group` (
`id` smallint(5) unsigned NOT NULL,
  `typeid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `sim_model` (
...
INSERT INTO `sim_model` (`modelid`, `siteid`, `name`, `description`, `tablename`, `setting`, `addtime`, `items`, `enablesearch`, `disabled`, `default_style`, `category_template`, `list_template`, `show_template`, `js_template`, `admin_list_template`, `member_add_template`, `member_list_template`, `sort`, `type`) VALUES
...
--
-- 表的结构 `sim_model_field`
--

CREATE TABLE IF NOT EXISTS `sim_model_field` (
...
--
-- 转存表中的数据 `sim_model_field`
--

INSERT INTO `sim_model_field` (`fieldid`, `modelid`, `siteid`, `field`, `name`, `tips`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `formattribute`, `unsetgroupids`, `unsetroleids`, `iscore`, `issystem`, `isunique`, `isbase`, `issearch`, `isadd`, `isfulltext`, `isposition`, `listorder`, `disabled`, `isomnipotent`) VALUES
...
CREATE TABLE IF NOT EXISTS `sim_module` (
  `module` varchar(15) NOT NULL,
  `name` varchar(20) NOT NULL,
...
INSERT INTO `sim_module` (`module`, `name`, `url`, `iscore`, `version`, `description`, `setting`, `listorder`, `disabled`, `installdate`, `updatedate`) VALUES
...
('announce', '公告', 'announce/', 0, '1.0', '公告', '', 0, 0, '2015-01-10', '2015-01-10'),
('comment', '评论', 'comment/', 0, '1.0', '评论', '', 0, 0, '2015-01-10', '2015-01-10'),
('link', '友情链接', '', 0, '1.0', '', 'array (\n  1 => \n  array (\n    ''is_post'' => ''1'',\n    ''enablecheckcode'' => ''0'',\n  ),\n)', 0, 0, '2010-09-06', '2010-09-06'),
('vote', '投票', '', 0, '1.0', '', 'array (\r\n  1 => \r\n  array (\r\n    ''default_style'' => ''default'',\r\n    ''vote_tp_template'' => ''vote_tp'',\r\n    ''allowguest'' => ''1'',\r\n    ''enabled'' => ''1'',\r\n    ''interval'' => ''1'',\r\n    ''credit'' => ''1'',\r\n  ),\r\n)', 0, 0, '2010-09-06', '2010-09-06'),
('message', '短消息', '', 0, '1.0', '', '', 0, 0, '2010-09-06', '2010-09-06'),
('mood', '新闻心情', 'mood/', 0, '1.0', '新闻心情', '', 0, 0, '2015-01-10', '2015-01-10'),
('poster', '广告模块', 'poster/', 0, '1.0', '广告模块', '', 0, 0, '2015-01-10', '2015-01-10'),
('formguide', '表单向导', 'formguide/', 0, '1.0', 'formguide', 'array (\n  ''allowmultisubmit'' => ''1'',\n  ''interval'' => ''30'',\n  ''allowunreg'' => ''0'',\n  ''mailmessage'' => ''用户向我们提交了表单数据，赶快去看看吧。'',\n)', 0, 0, '2010-10-20', '2010-10-20'),
('wap', '手机门户', 'wap/', 0, '1.0', '手机门户', '', 0, 0, '2015-01-10', '2015-01-10'),
('upgrade', '在线升级', '', 0, '1.0', '', '', 0, 0, '2011-05-18', '2011-05-18'),
('tag', '标签向导', 'tag/', 0, '1.0', '标签向导', '', 0, 0, '2015-01-10', '2015-01-10'),
...
CREATE TABLE IF NOT EXISTS `sim_mood` (
`id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_news_data` (
  `id` mediumint(8) unsigned DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `sim_page` (
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_pay_account`
--

CREATE TABLE IF NOT EXISTS `sim_pay_account` (
`id` mediumint(8) unsigned NOT NULL,
...
--
-- 表的结构 `sim_pay_payment`
--

CREATE TABLE IF NOT EXISTS `sim_pay_payment` (
...
CREATE TABLE IF NOT EXISTS `sim_pay_spend` (
`id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_picture` (
`id` mediumint(8) unsigned NOT NULL,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `typeid` smallint(5) unsigned NOT NULL,
  `title` char(80) NOT NULL DEFAULT '',
...
--
-- 表的结构 `sim_picture_data`
--

CREATE TABLE IF NOT EXISTS `sim_picture_data` (
  `id` mediumint(8) unsigned DEFAULT '0',
  `content` text NOT NULL,
  `readpoint` smallint(5) unsigned NOT NULL DEFAULT '0',
  `groupids_view` varchar(100) NOT NULL,
...
--
-- 转存表中的数据 `sim_position`
--

INSERT INTO `sim_position` (`posid`, `modelid`, `catid`, `name`, `maxnum`, `extention`, `listorder`, `siteid`, `thumb`) VALUES
...
--
-- 表的结构 `sim_position_data`
--

CREATE TABLE IF NOT EXISTS `sim_position_data` (
...
CREATE TABLE IF NOT EXISTS `sim_poster` (
`id` smallint(5) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `sim_poster` (`id`, `siteid`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 1, 'banner', 1, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.phpcms.cn'',\n    ''imageurl'' => ''http://www.yezi.com/phpcms-site/test/uploadfile/poster/2.png'',\n    ''alt'' => '''',\n  ),\n)', 1285813808, 1446249600, 1285813833, 0, 1, 0, 0),
(2, 1, 'phpcmsv9', 2, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.phpcms.cn'',\n    ''imageurl'' => ''http://www.yezi.com/phpcms-site/test/statics/images/v9/ad_login.jpg'',\n    ''alt'' => ''phpcms专业建站系统'',\n  ),\n)', 1285816298, 1446249600, 1285816310, 0, 1, 0, 0),
(3, 1, 'phpcms下载推荐', 3, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.phpcms.cn'',\n    ''imageurl'' => ''http://www.yezi.com/phpcms-site/test/uploadfile/poster/3.png'',\n    ''alt'' => ''phpcms官方'',\n  ),\n)', 1286504815, 1446249600, 1286504865, 0, 1, 0, 0),
(4, 1, 'phpcms广告', 4, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.phpcms.cn'',\n    ''imageurl'' => ''http://www.yezi.com/phpcms-site/test/uploadfile/poster/4.gif'',\n    ''alt'' => ''phpcms官方'',\n  ),\n)', 1286505141, 1446249600, 1286505178, 0, 0, 0, 0),
(5, 1, 'phpcms下载', 5, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.phpcms.cn'',\n    ''imageurl'' => ''http://www.yezi.com/phpcms-site/test/uploadfile/poster/5.gif'',\n    ''alt'' => ''官方'',\n  ),\n)', 1286509363, 1446249600, 1286509401, 0, 0, 0, 0),
...
--
-- 表的结构 `sim_poster_space`
--

CREATE TABLE IF NOT EXISTS `sim_poster_space` (
...
--
-- 转存表中的数据 `sim_poster_space`
--

INSERT INTO `sim_poster_space` (`spaceid`, `siteid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
...
--
-- 表的结构 `sim_release_point`
--

CREATE TABLE IF NOT EXISTS `sim_release_point` (
`id` mediumint(8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_search` (
...
--
-- 表的结构 `sim_search_keyword`
--

CREATE TABLE IF NOT EXISTS `sim_search_keyword` (
...
INSERT INTO `sim_session` (`sessionid`, `userid`, `ip`, `lastvisit`, `roleid`, `groupid`, `m`, `c`, `a`, `data`) VALUES
('ejghk31b3jni3eustva5k6vdu0', 0, '127.0.0.1', 1420866591, 0, 0, '', '', '', 'code|s:4:"bn44";');
...
CREATE TABLE IF NOT EXISTS `sim_site` (
...
INSERT INTO `sim_site` (`siteid`, `name`, `dirname`, `domain`, `site_title`, `keywords`, `description`, `release_point`, `default_style`, `template`, `setting`, `uuid`) VALUES
(1, '默认站点', '', 'http://www.yezi.com/phpcms-site/test/', 'PHPCMS演示站', 'PHPCMS演示站', 'PHPCMS演示站', '', 'default', 'default', 'array (\n  ''upload_maxsize'' => ''2048'',\n  ''upload_allowext'' => ''jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf'',\n  ''watermark_enable'' => ''1'',\n  ''watermark_minwidth'' => ''300'',\n  ''watermark_minheight'' => ''300'',\n  ''watermark_img'' => ''/statics/images/water/mark.png'',\n  ''watermark_pct'' => ''85'',\n  ''watermark_quality'' => ''80'',\n  ''watermark_pos'' => ''9'',\n)', '');
...
CREATE TABLE IF NOT EXISTS `sim_sms_report` (
...
CREATE TABLE IF NOT EXISTS `sim_special` (
`id` smallint(5) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_special_content`
--

CREATE TABLE IF NOT EXISTS `sim_special_content` (
`id` mediumint(8) unsigned NOT NULL,
...
--
-- 表的结构 `sim_special_c_data`
--

CREATE TABLE IF NOT EXISTS `sim_special_c_data` (
  `id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_sphinx_counter`
--

CREATE TABLE IF NOT EXISTS `sim_sphinx_counter` (
...
CREATE TABLE IF NOT EXISTS `sim_sso_admin` (
...
--
-- 转存表中的数据 `sim_sso_admin`
--

INSERT INTO `sim_sso_admin` (`id`, `username`, `password`, `encrypt`, `issuper`, `lastlogin`, `ip`) VALUES
(1, 'admin', 'b14f3de493bd4bef1763617fe77ffec4', 'mNJCy9', 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `sim_sso_applications`
--

CREATE TABLE IF NOT EXISTS `sim_sso_applications` (
...
--
-- 转存表中的数据 `sim_sso_applications`
--

INSERT INTO `sim_sso_applications` (`appid`, `type`, `name`, `url`, `authkey`, `ip`, `apifilename`, `charset`, `synlogin`) VALUES
(1, 'phpcms_v9', 'phpcms v9', 'http://www.yezi.com/phpcms-site/test/', 'wNlOqzePeBwYTZexnByGvvKSaoEmLF0F', '', 'api.php?op=phpsso', 'utf-8', 1);

-- --------------------------------------------------------

--
-- 表的结构 `sim_sso_members`
--

CREATE TABLE IF NOT EXISTS `sim_sso_members` (
...
--
-- 表的结构 `sim_sso_messagequeue`
--

CREATE TABLE IF NOT EXISTS `sim_sso_messagequeue` (
`id` int(10) unsigned NOT NULL,
...
--
-- 表的结构 `sim_sso_session`
--

CREATE TABLE IF NOT EXISTS `sim_sso_session` (
  `sessionid` char(32) NOT NULL,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `ip` char(15) NOT NULL,
  `lastvisit` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `sim_sso_settings`
--

CREATE TABLE IF NOT EXISTS `sim_sso_settings` (
  `name` varchar(32) NOT NULL DEFAULT '',
  `data` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `sim_sso_settings`
--

INSERT INTO `sim_sso_settings` (`name`, `data`) VALUES
('denyemail', ''),
('denyusername', ''),
('creditrate', ''),
('sp4', ''),
...
CREATE TABLE IF NOT EXISTS `sim_tag` (
`id` mediumint(8) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `tag` text NOT NULL,
...
--
-- 表的结构 `sim_template_bak`
--

CREATE TABLE IF NOT EXISTS `sim_template_bak` (
`id` int(10) NOT NULL,
  `creat_at` int(10) unsigned DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `sim_times` (
  `username` char(40) NOT NULL,
  `ip` char(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sim_type` (
`typeid` smallint(5) unsigned NOT NULL,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `module` char(15) NOT NULL,
  `modelid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `sim_type` (`typeid`, `siteid`, `module`, `modelid`, `name`, `parentid`, `typedir`, `url`, `template`, `listorder`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `sim_urlrule` (
...
INSERT INTO `sim_urlrule` (`urlruleid`, `module`, `file`, `ishtml`, `urlrule`, `example`) VALUES
...
CREATE TABLE IF NOT EXISTS `sim_video` (
`id` mediumint(8) unsigned NOT NULL,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `typeid` smallint(5) unsigned NOT NULL,
  `title` char(80) NOT NULL DEFAULT '',
...
--
-- 表的结构 `sim_video_content`
--

CREATE TABLE IF NOT EXISTS `sim_video_content` (
...
CREATE TABLE IF NOT EXISTS `sim_video_data` (
  `id` mediumint(8) unsigned DEFAULT '0',
  `content` text NOT NULL,
  `readpoint` smallint(5) unsigned NOT NULL DEFAULT '0',
  `groupids_view` varchar(100) NOT NULL,
...
--
-- 表的结构 `sim_video_store`
--

CREATE TABLE IF NOT EXISTS `sim_video_store` (
...
CREATE TABLE IF NOT EXISTS `sim_vote_data` (
  `userid` mediumint(8) unsigned DEFAULT '0',
  `username` char(20) NOT NULL,
...
--
-- 表的结构 `sim_vote_option`
--

CREATE TABLE IF NOT EXISTS `sim_vote_option` (
...
--
-- 表的结构 `sim_vote_subject`
--

CREATE TABLE IF NOT EXISTS `sim_vote_subject` (
...
CREATE TABLE IF NOT EXISTS `sim_wap` (
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '1',
...
INSERT INTO `sim_wap` (`siteid`, `sitename`, `logo`, `domain`, `setting`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `sim_wap_type` (
...
--
-- 转存表中的数据 `sim_workflow`
--

INSERT INTO `sim_workflow` (`workflowid`, `siteid`, `steps`, `workname`, `description`, `setting`, `flag`) VALUES
(1, 1, 1, '一级审核', '审核一次', '', 0),
(2, 1, 2, '二级审核', '审核两次', '', 0),
(3, 1, 3, '三级审核', '审核三次', '', 0),
(4, 1, 4, '四级审核', '四级审核', '', 0);
...
--
-- Indexes for table `sim_admin`
--
ALTER TABLE `sim_admin`
 ADD PRIMARY KEY (`userid`), ADD KEY `username` (`username`);

--
-- Indexes for table `sim_admin_panel`
--
ALTER TABLE `sim_admin_panel`
 ADD UNIQUE KEY `userid` (`menuid`,`userid`);

--
-- Indexes for table `sim_admin_role`
--
ALTER TABLE `sim_admin_role`
 ADD PRIMARY KEY (`roleid`), ADD KEY `listorder` (`listorder`), ADD KEY `disabled` (`disabled`);

--
-- Indexes for table `sim_admin_role_priv`
--
ALTER TABLE `sim_admin_role_priv`
 ADD KEY `roleid` (`roleid`,`m`,`c`,`a`,`siteid`);

--
-- Indexes for table `sim_announce`
--
ALTER TABLE `sim_announce`
 ADD PRIMARY KEY (`aid`), ADD KEY `siteid` (`siteid`,`passed`,`endtime`);

--
-- Indexes for table `sim_attachment`
--
ALTER TABLE `sim_attachment`
 ADD PRIMARY KEY (`aid`), ADD KEY `authcode` (`authcode`);

--
-- Indexes for table `sim_attachment_index`
--
ALTER TABLE `sim_attachment_index`
 ADD KEY `keyid` (`keyid`), ADD KEY `aid` (`aid`);

--
-- Indexes for table `sim_badword`
--
ALTER TABLE `sim_badword`
 ADD PRIMARY KEY (`badid`), ADD UNIQUE KEY `badword` (`badword`), ADD KEY `usetimes` (`replaceword`,`listorder`), ADD KEY `hits` (`listorder`);

--
-- Indexes for table `sim_block`
--
ALTER TABLE `sim_block`
 ADD PRIMARY KEY (`id`), ADD KEY `pos` (`pos`), ADD KEY `type` (`type`), ADD KEY `siteid` (`siteid`);

--
-- Indexes for table `sim_block_history`
--
ALTER TABLE `sim_block_history`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_block_priv`
--
ALTER TABLE `sim_block_priv`
 ADD PRIMARY KEY (`id`), ADD KEY `blockid` (`blockid`), ADD KEY `roleid` (`roleid`,`siteid`);

--
-- Indexes for table `sim_cache`
--
ALTER TABLE `sim_cache`
 ADD PRIMARY KEY (`filename`,`path`);

--
-- Indexes for table `sim_category`
--
ALTER TABLE `sim_category`
 ADD PRIMARY KEY (`catid`), ADD KEY `module` (`module`,`parentid`,`listorder`,`catid`), ADD KEY `siteid` (`siteid`,`type`);

--
-- Indexes for table `sim_category_priv`
--
ALTER TABLE `sim_category_priv`
 ADD KEY `catid` (`catid`,`roleid`,`is_admin`,`action`), ADD KEY `siteid` (`siteid`);

--
-- Indexes for table `sim_collection_content`
--
ALTER TABLE `sim_collection_content`
 ADD PRIMARY KEY (`id`), ADD KEY `nodeid` (`nodeid`,`siteid`), ADD KEY `status` (`status`);

--
-- Indexes for table `sim_collection_history`
--
ALTER TABLE `sim_collection_history`
 ADD PRIMARY KEY (`md5`,`siteid`);

--
-- Indexes for table `sim_collection_node`
--
ALTER TABLE `sim_collection_node`
 ADD PRIMARY KEY (`nodeid`), ADD KEY `siteid` (`siteid`);

--
-- Indexes for table `sim_collection_program`
--
ALTER TABLE `sim_collection_program`
...
--
-- Indexes for table `sim_comment_check`
--
ALTER TABLE `sim_comment_check`
 ADD PRIMARY KEY (`id`), ADD KEY `siteid` (`siteid`), ADD KEY `comment_data_id` (`comment_data_id`);

--
-- Indexes for table `sim_comment_data_1`
--
ALTER TABLE `sim_comment_data_1`
 ADD PRIMARY KEY (`id`), ADD KEY `commentid` (`commentid`), ADD KEY `direction` (`direction`), ADD KEY `siteid` (`siteid`), ADD KEY `support` (`support`);

--
-- Indexes for table `sim_comment_setting`
--
ALTER TABLE `sim_comment_setting`
 ADD PRIMARY KEY (`siteid`);

--
-- Indexes for table `sim_comment_table`
--
ALTER TABLE `sim_comment_table`
 ADD PRIMARY KEY (`tableid`);

--
-- Indexes for table `sim_content_check`
--
ALTER TABLE `sim_content_check`
 ADD KEY `username` (`username`), ADD KEY `checkid` (`checkid`), ADD KEY `status` (`status`,`inputtime`);

--
-- Indexes for table `sim_copyfrom`
--
ALTER TABLE `sim_copyfrom`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_datacall`
--
ALTER TABLE `sim_datacall`
 ADD PRIMARY KEY (`id`), ADD KEY `type` (`type`);

--
-- Indexes for table `sim_dbsource`
--
ALTER TABLE `sim_dbsource`
 ADD PRIMARY KEY (`id`), ADD KEY `siteid` (`siteid`);

--
-- Indexes for table `sim_download`
--
ALTER TABLE `sim_download`
...
--
-- Indexes for table `sim_download_data`
--
ALTER TABLE `sim_download_data`
 ADD KEY `id` (`id`);

--
-- Indexes for table `sim_downservers`
--
ALTER TABLE `sim_downservers`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_extend_setting`
--
ALTER TABLE `sim_extend_setting`
 ADD PRIMARY KEY (`id`), ADD KEY `key` (`key`);

--
-- Indexes for table `sim_favorite`
--
ALTER TABLE `sim_favorite`
 ADD PRIMARY KEY (`id`), ADD KEY `userid` (`userid`);

--
-- Indexes for table `sim_hits`
--
ALTER TABLE `sim_hits`
 ADD PRIMARY KEY (`hitsid`);

--
-- Indexes for table `sim_ipbanned`
--
ALTER TABLE `sim_ipbanned`
 ADD PRIMARY KEY (`ipbannedid`);

--
-- Indexes for table `sim_keylink`
--
ALTER TABLE `sim_keylink`
 ADD PRIMARY KEY (`keylinkid`);

--
-- Indexes for table `sim_keyword`
--
ALTER TABLE `sim_keyword`
 ADD PRIMARY KEY (`id`), ADD KEY `keyword` (`keyword`,`siteid`);

--
-- Indexes for table `sim_keyword_data`
--
ALTER TABLE `sim_keyword_data`
 ADD PRIMARY KEY (`id`), ADD KEY `tagid` (`tagid`,`siteid`);

--
-- Indexes for table `sim_link`
--
ALTER TABLE `sim_link`
 ADD PRIMARY KEY (`linkid`), ADD KEY `typeid` (`typeid`,`passed`,`listorder`,`linkid`);

--
-- Indexes for table `sim_linkage`
--
ALTER TABLE `sim_linkage`
 ADD PRIMARY KEY (`linkageid`,`keyid`), ADD KEY `parentid` (`parentid`,`listorder`);

--
-- Indexes for table `sim_log`
--
ALTER TABLE `sim_log`
 ADD PRIMARY KEY (`logid`), ADD KEY `module` (`module`,`file`,`action`), ADD KEY `username` (`username`,`action`);

--
-- Indexes for table `sim_member`
--
ALTER TABLE `sim_member`
 ADD PRIMARY KEY (`userid`), ADD UNIQUE KEY `username` (`username`), ADD KEY `email` (`email`(20)), ADD KEY `phpssouid` (`phpssouid`);

--
-- Indexes for table `sim_member_detail`
--
ALTER TABLE `sim_member_detail`
 ADD UNIQUE KEY `userid` (`userid`);

--
-- Indexes for table `sim_member_group`
--
ALTER TABLE `sim_member_group`
 ADD PRIMARY KEY (`groupid`), ADD KEY `disabled` (`disabled`), ADD KEY `listorder` (`sort`);

--
-- Indexes for table `sim_member_menu`
--
ALTER TABLE `sim_member_menu`
 ADD PRIMARY KEY (`id`), ADD KEY `listorder` (`listorder`), ADD KEY `parentid` (`parentid`), ADD KEY `module` (`m`,`c`,`a`);

--
-- Indexes for table `sim_member_verify`
--
ALTER TABLE `sim_member_verify`
 ADD PRIMARY KEY (`userid`), ADD UNIQUE KEY `username` (`username`), ADD KEY `email` (`email`(20));

--
-- Indexes for table `sim_member_vip`
--
ALTER TABLE `sim_member_vip`
 ADD UNIQUE KEY `userid` (`userid`);

--
-- Indexes for table `sim_menu`
--
ALTER TABLE `sim_menu`
 ADD PRIMARY KEY (`id`), ADD KEY `listorder` (`listorder`), ADD KEY `parentid` (`parentid`), ADD KEY `module` (`m`,`c`,`a`);

--
-- Indexes for table `sim_message`
--
ALTER TABLE `sim_message`
 ADD PRIMARY KEY (`messageid`), ADD KEY `msgtoid` (`send_to_id`,`folder`), ADD KEY `replyid` (`replyid`), ADD KEY `folder` (`send_from_id`,`folder`);

--
-- Indexes for table `sim_message_data`
--
ALTER TABLE `sim_message_data`
 ADD PRIMARY KEY (`id`), ADD KEY `message` (`userid`,`group_message_id`);

--
-- Indexes for table `sim_message_group`
--
ALTER TABLE `sim_message_group`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_model`
--
ALTER TABLE `sim_model`
 ADD PRIMARY KEY (`modelid`), ADD KEY `type` (`type`,`siteid`);

--
-- Indexes for table `sim_model_field`
--
ALTER TABLE `sim_model_field`
 ADD PRIMARY KEY (`fieldid`), ADD KEY `modelid` (`modelid`,`disabled`), ADD KEY `field` (`field`,`modelid`);

--
-- Indexes for table `sim_module`
--
ALTER TABLE `sim_module`
 ADD PRIMARY KEY (`module`);

--
-- Indexes for table `sim_mood`
--
ALTER TABLE `sim_mood`
 ADD PRIMARY KEY (`id`), ADD KEY `total` (`total`), ADD KEY `lastupdate` (`lastupdate`), ADD KEY `catid` (`catid`,`siteid`,`contentid`);

--
-- Indexes for table `sim_news`
--
ALTER TABLE `sim_news`
 ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`,`listorder`,`id`), ADD KEY `listorder` (`catid`,`status`,`listorder`,`id`), ADD KEY `catid` (`catid`,`status`,`id`);

--
-- Indexes for table `sim_news_data`
--
ALTER TABLE `sim_news_data`
 ADD KEY `id` (`id`);

--
-- Indexes for table `sim_page`
--
ALTER TABLE `sim_page`
 ADD KEY `catid` (`catid`);

--
-- Indexes for table `sim_pay_account`
--
ALTER TABLE `sim_pay_account`
 ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`), ADD KEY `userid` (`userid`), ADD KEY `trade_sn` (`trade_sn`,`money`,`status`,`id`);

--
-- Indexes for table `sim_pay_payment`
--
ALTER TABLE `sim_pay_payment`
 ADD PRIMARY KEY (`pay_id`), ADD KEY `pay_code` (`pay_code`);

--
-- Indexes for table `sim_pay_spend`
--
ALTER TABLE `sim_pay_spend`
 ADD PRIMARY KEY (`id`), ADD KEY `type` (`type`), ADD KEY `creat_at` (`creat_at`), ADD KEY `logo` (`logo`), ADD KEY `userid` (`userid`);

--
-- Indexes for table `sim_picture`
--
ALTER TABLE `sim_picture`
 ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`,`listorder`,`id`), ADD KEY `listorder` (`catid`,`status`,`listorder`,`id`), ADD KEY `catid` (`catid`,`status`,`id`);

--
-- Indexes for table `sim_picture_data`
--
ALTER TABLE `sim_picture_data`
 ADD KEY `id` (`id`);

--
-- Indexes for table `sim_position`
--
ALTER TABLE `sim_position`
 ADD PRIMARY KEY (`posid`);

--
-- Indexes for table `sim_position_data`
--
ALTER TABLE `sim_position_data`
 ADD KEY `posid` (`posid`), ADD KEY `listorder` (`listorder`);

--
-- Indexes for table `sim_poster`
--
ALTER TABLE `sim_poster`
 ADD PRIMARY KEY (`id`), ADD KEY `spaceid` (`spaceid`,`siteid`,`disabled`,`listorder`);

--
-- Indexes for table `sim_poster_201501`
--
ALTER TABLE `sim_poster_201501`
 ADD PRIMARY KEY (`id`), ADD KEY `pid` (`pid`,`type`,`ip`);

--
-- Indexes for table `sim_poster_space`
--
ALTER TABLE `sim_poster_space`
 ADD PRIMARY KEY (`spaceid`), ADD KEY `disabled` (`disabled`,`siteid`);

--
-- Indexes for table `sim_queue`
--
ALTER TABLE `sim_queue`
 ADD PRIMARY KEY (`id`), ADD KEY `siteid` (`siteid`), ADD KEY `times` (`times`);

--
-- Indexes for table `sim_release_point`
--
ALTER TABLE `sim_release_point`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_search`
--
ALTER TABLE `sim_search`
 ADD PRIMARY KEY (`searchid`), ADD KEY `typeid` (`typeid`,`id`), ADD KEY `siteid` (`siteid`), ADD FULLTEXT KEY `data` (`data`);

--
-- Indexes for table `sim_search_keyword`
--
ALTER TABLE `sim_search_keyword`
 ADD UNIQUE KEY `keyword` (`keyword`), ADD UNIQUE KEY `pinyin` (`pinyin`), ADD FULLTEXT KEY `data` (`data`);

--
-- Indexes for table `sim_session`
--
ALTER TABLE `sim_session`
 ADD PRIMARY KEY (`sessionid`), ADD KEY `lastvisit` (`lastvisit`);

--
-- Indexes for table `sim_site`
--
ALTER TABLE `sim_site`
 ADD PRIMARY KEY (`siteid`);

--
-- Indexes for table `sim_sms_report`
--
ALTER TABLE `sim_sms_report`
 ADD PRIMARY KEY (`id`), ADD KEY `mobile` (`mobile`,`posttime`);

--
-- Indexes for table `sim_special`
--
ALTER TABLE `sim_special`
 ADD PRIMARY KEY (`id`), ADD KEY `disabled` (`disabled`,`siteid`);

--
-- Indexes for table `sim_special_content`
--
ALTER TABLE `sim_special_content`
 ADD PRIMARY KEY (`id`), ADD KEY `specialid` (`specialid`,`typeid`,`isdata`), ADD KEY `typeid` (`typeid`,`isdata`);

--
-- Indexes for table `sim_special_c_data`
--
ALTER TABLE `sim_special_c_data`
 ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `sim_sphinx_counter`
--
ALTER TABLE `sim_sphinx_counter`
 ADD PRIMARY KEY (`counter_id`);

--
-- Indexes for table `sim_sso_admin`
--
ALTER TABLE `sim_sso_admin`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `username` (`username`);

--
-- Indexes for table `sim_sso_applications`
--
ALTER TABLE `sim_sso_applications`
 ADD PRIMARY KEY (`appid`), ADD KEY `synlogin` (`synlogin`);

--
-- Indexes for table `sim_sso_members`
--
ALTER TABLE `sim_sso_members`
 ADD PRIMARY KEY (`uid`), ADD UNIQUE KEY `username` (`username`), ADD KEY `email` (`email`), ADD KEY `ucuserid` (`ucuserid`);

--
-- Indexes for table `sim_sso_messagequeue`
--
ALTER TABLE `sim_sso_messagequeue`
 ADD PRIMARY KEY (`id`), ADD KEY `dateline` (`dateline`), ADD KEY `succeed` (`succeed`,`id`);

--
-- Indexes for table `sim_sso_session`
--
ALTER TABLE `sim_sso_session`
 ADD PRIMARY KEY (`sessionid`), ADD KEY `lastvisit` (`lastvisit`);

--
-- Indexes for table `sim_sso_settings`
--
ALTER TABLE `sim_sso_settings`
 ADD PRIMARY KEY (`name`);

--
-- Indexes for table `sim_tag`
--
ALTER TABLE `sim_tag`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sim_template_bak`
--
ALTER TABLE `sim_template_bak`
 ADD PRIMARY KEY (`id`), ADD KEY `fileid` (`fileid`);

--
-- Indexes for table `sim_times`
--
ALTER TABLE `sim_times`
 ADD PRIMARY KEY (`username`,`isadmin`);

--
-- Indexes for table `sim_type`
--
ALTER TABLE `sim_type`
 ADD PRIMARY KEY (`typeid`), ADD KEY `module` (`module`,`parentid`,`siteid`,`listorder`);

--
-- Indexes for table `sim_urlrule`
--
ALTER TABLE `sim_urlrule`
 ADD PRIMARY KEY (`urlruleid`);

--
-- Indexes for table `sim_video`
--
ALTER TABLE `sim_video`
 ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`,`listorder`,`id`), ADD KEY `listorder` (`catid`,`status`,`listorder`,`id`), ADD KEY `catid` (`catid`,`status`,`id`);

--
-- Indexes for table `sim_video_content`
--
ALTER TABLE `sim_video_content`
 ADD KEY `videoid` (`videoid`);

--
-- Indexes for table `sim_video_data`
--
ALTER TABLE `sim_video_data`
 ADD KEY `id` (`id`);

--
-- Indexes for table `sim_video_store`
--
ALTER TABLE `sim_video_store`
 ADD PRIMARY KEY (`videoid`), ADD KEY `videoid` (`videoid`,`status`);

--
-- Indexes for table `sim_vote_data`
--
ALTER TABLE `sim_vote_data`
 ADD KEY `subjectid` (`subjectid`), ADD KEY `userid` (`userid`), ADD KEY `ip` (`ip`);

--
-- Indexes for table `sim_vote_option`
--
ALTER TABLE `sim_vote_option`
 ADD PRIMARY KEY (`optionid`), ADD KEY `subjectid` (`subjectid`);

--
-- Indexes for table `sim_vote_subject`
--
ALTER TABLE `sim_vote_subject`
 ADD PRIMARY KEY (`subjectid`), ADD KEY `enabled` (`enabled`), ADD KEY `fromdate` (`fromdate`,`todate`), ADD KEY `todate` (`todate`);

--
-- Indexes for table `sim_wap`
--
ALTER TABLE `sim_wap`
 ADD PRIMARY KEY (`siteid`);

--
-- Indexes for table `sim_wap_type`
--
ALTER TABLE `sim_wap_type`
 ADD PRIMARY KEY (`typeid`);

--
-- Indexes for table `sim_workflow`
--
...
--
-- AUTO_INCREMENT for table `sim_admin`
--
ALTER TABLE `sim_admin`
MODIFY `userid` mediumint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_admin_role`
--
ALTER TABLE `sim_admin_role`
MODIFY `roleid` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `sim_announce`
--
ALTER TABLE `sim_announce`
MODIFY `aid` smallint(4) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_attachment`
--
ALTER TABLE `sim_attachment`
MODIFY `aid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_badword`
--
ALTER TABLE `sim_badword`
MODIFY `badid` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_block`
--
ALTER TABLE `sim_block`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_block_history`
--
ALTER TABLE `sim_block_history`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_block_priv`
--
ALTER TABLE `sim_block_priv`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_category`
--
ALTER TABLE `sim_category`
MODIFY `catid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `sim_collection_content`
--
ALTER TABLE `sim_collection_content`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_collection_node`
--
ALTER TABLE `sim_collection_node`
MODIFY `nodeid` smallint(6) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_collection_program`
--
ALTER TABLE `sim_collection_program`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_comment_check`
--
ALTER TABLE `sim_comment_check`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_comment_data_1`
--
ALTER TABLE `sim_comment_data_1`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论ID';
--
-- AUTO_INCREMENT for table `sim_comment_table`
--
ALTER TABLE `sim_comment_table`
MODIFY `tableid` mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '表ID号',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_copyfrom`
--
ALTER TABLE `sim_copyfrom`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_datacall`
--
ALTER TABLE `sim_datacall`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_dbsource`
--
ALTER TABLE `sim_dbsource`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_download`
--
ALTER TABLE `sim_download`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_downservers`
--
ALTER TABLE `sim_downservers`
MODIFY `id` mediumint(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_extend_setting`
--
ALTER TABLE `sim_extend_setting`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_favorite`
--
ALTER TABLE `sim_favorite`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_ipbanned`
--
ALTER TABLE `sim_ipbanned`
MODIFY `ipbannedid` smallint(5) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_keylink`
--
ALTER TABLE `sim_keylink`
MODIFY `keylinkid` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_keyword`
--
ALTER TABLE `sim_keyword`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_keyword_data`
--
ALTER TABLE `sim_keyword_data`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_link`
--
ALTER TABLE `sim_link`
MODIFY `linkid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `sim_linkage`
--
ALTER TABLE `sim_linkage`
MODIFY `linkageid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3360;
--
-- AUTO_INCREMENT for table `sim_log`
--
ALTER TABLE `sim_log`
MODIFY `logid` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_member`
--
ALTER TABLE `sim_member`
MODIFY `userid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_member_group`
--
ALTER TABLE `sim_member_group`
MODIFY `groupid` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `sim_member_menu`
--
ALTER TABLE `sim_member_menu`
MODIFY `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `sim_member_verify`
--
ALTER TABLE `sim_member_verify`
MODIFY `userid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_menu`
--
ALTER TABLE `sim_menu`
MODIFY `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1577;
--
-- AUTO_INCREMENT for table `sim_message`
--
ALTER TABLE `sim_message`
MODIFY `messageid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_message_data`
--
ALTER TABLE `sim_message_data`
MODIFY `id` int(4) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_message_group`
--
ALTER TABLE `sim_message_group`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_model`
--
ALTER TABLE `sim_model`
MODIFY `modelid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `sim_model_field`
--
ALTER TABLE `sim_model_field`
MODIFY `fieldid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=108;
--
-- AUTO_INCREMENT for table `sim_mood`
--
ALTER TABLE `sim_mood`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_news`
--
ALTER TABLE `sim_news`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_pay_account`
--
ALTER TABLE `sim_pay_account`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_pay_payment`
--
ALTER TABLE `sim_pay_payment`
MODIFY `pay_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_pay_spend`
--
ALTER TABLE `sim_pay_spend`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_picture`
--
ALTER TABLE `sim_picture`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_position`
--
ALTER TABLE `sim_position`
MODIFY `posid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `sim_poster`
--
ALTER TABLE `sim_poster`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `sim_poster_201501`
--
ALTER TABLE `sim_poster_201501`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_poster_space`
--
ALTER TABLE `sim_poster_space`
MODIFY `spaceid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `sim_queue`
--
ALTER TABLE `sim_queue`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_release_point`
--
ALTER TABLE `sim_release_point`
MODIFY `id` mediumint(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_search`
--
ALTER TABLE `sim_search`
MODIFY `searchid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_site`
--
ALTER TABLE `sim_site`
MODIFY `siteid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_sms_report`
--
ALTER TABLE `sim_sms_report`
MODIFY `id` bigint(15) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_special`
--
ALTER TABLE `sim_special`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_special_content`
--
ALTER TABLE `sim_special_content`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_sso_admin`
--
ALTER TABLE `sim_sso_admin`
MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_sso_applications`
--
ALTER TABLE `sim_sso_applications`
MODIFY `appid` smallint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sim_sso_members`
--
ALTER TABLE `sim_sso_members`
MODIFY `uid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_sso_messagequeue`
--
ALTER TABLE `sim_sso_messagequeue`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_tag`
--
ALTER TABLE `sim_tag`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_template_bak`
--
ALTER TABLE `sim_template_bak`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_type`
--
ALTER TABLE `sim_type`
MODIFY `typeid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT for table `sim_urlrule`
--
ALTER TABLE `sim_urlrule`
MODIFY `urlruleid` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `sim_video`
--
ALTER TABLE `sim_video`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_video_store`
--
ALTER TABLE `sim_video_store`
MODIFY `videoid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_vote_option`
--
ALTER TABLE `sim_vote_option`
MODIFY `optionid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_vote_subject`
--
ALTER TABLE `sim_vote_subject`
MODIFY `subjectid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_wap_type`
--
ALTER TABLE `sim_wap_type`
MODIFY `typeid` smallint(5) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sim_workflow`
--
ALTER TABLE `sim_workflow`
